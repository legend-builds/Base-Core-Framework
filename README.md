# ⚡ Base Core Framework (Solidity & TypeScript)
...
- **Assertion:** Chai & Ethers.js (v6)

## 🚀 Getting Started

### Installation
```bash
git clone [https://github.com/legend-builds/Base-Core-Framework.git](https://github.com/legend-builds/Base-Core-Framework.git)
cd Base-Core-Framework
npm install
